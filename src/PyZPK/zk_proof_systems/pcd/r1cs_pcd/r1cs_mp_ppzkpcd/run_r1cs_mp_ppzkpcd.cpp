...
void init_zk_proof_systems_pcd_r1cs_pcd_r1cs_mp_ppzkpcd_run_r1cs_mp_ppzkpcd_tally_example(py::module &m)
{
    ...
    m.def("run_r1cs_mp_ppzkpcd_tally_example", &run_r1cs_mp_ppzkpcd_tally_example<PCD_ppT>, py::arg("wordsize"), py::arg("max_arity"), py::arg("depth"), py::arg("test_serialization"), py::arg("test_multi_type"), py::arg("test_same_type_optimization"));
}